<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="wx.Default" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnAdd" runat="server" Text="为该微信帐户绑定新安心贷帐户" OnClick="btnAdd_Click" />
